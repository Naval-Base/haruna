			...
			args: [
				{
					...
					type: 'playlist',
					prompt: {
						start: (message: Message): string => `${message.author}, what playlists description do you want to edit?`,
				...
				},
				{
					...
					type: 'string',
					prompt: {
						start: (message: Message): string => `${message.author}, what should the new description be?`
					}
				}
			]
		});
